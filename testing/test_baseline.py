...
File Description: This file tests the baseline binary classification finetuned models.
...
if __name__ == "__main__":
    ...
    model.load_state_dict(torch.load(f"../model/{args.model_type}_{args.run_id}_baseline.pt"))
    model.to(device)
